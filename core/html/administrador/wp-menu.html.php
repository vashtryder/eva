    <body class="kt-page--loading-enabled kt-page--loading kt-page--fixed kt-header--fixed kt-header--minimize-topbar kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-page--loading">
        ...
        <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
            <div class="kt-header-mobile__logo">
                <a href="index.html">
                    <img alt="Logo" src="public/img/sistema/logo/logo360_menu.png" />
                </a>
            </div>
                            ...
                            <div class="kt-container">
                                ...
                                <div class="kt-header__brand   kt-grid__item" id="kt_header_brand">
                                    <div class="kt-header__brand-logo">
                                        <a href="index.html">
                                            <img alt="Logo" src="public/img/sistema/logo/logo360_menu.png" width="30%" class="kt-header__brand-logo-default" />
                                            <img alt="Logo" src="public/img/sistema/logo/logo360_menu.png" width="30%" class="kt-header__brand-logo-sticky" />
                                        </a>
                                    </div>
                                ...
                                <div class="kt-header__topbar">
                                            ...
                                            <form>
                                                ...
                                                <div class="kt-head kt-head--skin-dark" style="background-image: url(assets/media/misc/bg-1.jpg)">
                                                    <h3 class="kt-head__title">
                                                        ...
                                                        <span class="btn btn-success btn-sm btn-bold btn-font-md">23 tareas pendientes</span>
                                                    </h3>
                                                </div>
                                    ...
                                    <div class="kt-header__topbar-item kt-header__topbar-item--user">
                                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,10px" aria-expanded="false">
                                            ...
                                            <span class="kt-header__topbar-username">Jean Carlos</span>
                                            <img class="kt-hidden" alt="Pic" src="public/img/personal/administrativo/default.jpg">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
                                            ...
                                            <!--begin: Head -->
                                            <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(public/img/sistema/cabecera/bg-1.jpg)">
                                            ...
                                            <div class="kt-notification">
                                                ...
                                                <a href="#" class="kt-notification__item">
                                                    ...
                                                    <div class="kt-notification__item-details">
                                                        ...
                                                        <div class="kt-notification__item-time">
                                                            Ultimas tareas & Proyectos
                                                        </div>
                                                    </div>
                                                </a>
                                                <div class="kt-notification__custom">
                                                    <a href="custom_user_login-v2.html" target="_blank" class="btn btn-label-brand btn-sm btn-bold">Cerrar Sesión</a>
                                                </div>
                                            </div>
                                    ...
                                    <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile ">
                                        <ul class="kt-menu__nav ">
                                            <li class="kt-menu__item  kt-menu__item--open kt-menu__item--here kt-menu__item--submenu kt-menu__item--rel kt-menu__item--open kt-menu__item--here" data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                                                <a href="?s=wp-admin" class="kt-menu__link">
