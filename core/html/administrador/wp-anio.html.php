                                    ...
                                    <div class="col-lg-3">
                                       <form>
                                            <div class="form-group">
                                                <label for="recipient-name" class="form-control-label">Año:</label>
                                                <input type="text" class="form-control" id="var_anio" name="var_anio">
                                            </div>
                                            <div class="form-group">
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">ACTUALIZAR AÑO</h5>
