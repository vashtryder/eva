                                    ...
                                    <div class="col-lg-3">
                                       <form>
                                            <div class="form-group">
                                                <label for="recipent-name" class="form-control-label ">Salón:</label>
                                                <select name="var_salon" id="var_salon" class="form-control selectSalon">
                                                    <option value="0">SELECCIONAR SALÓN</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="recipent-name" class="form-control-label ">Area Académica:</label>
                                                <select name="var_salon" id="var_salon" class="form-control selectSalon">
                                                    <option value="0">SELECCIONAR AREA ACADÉMICA</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
